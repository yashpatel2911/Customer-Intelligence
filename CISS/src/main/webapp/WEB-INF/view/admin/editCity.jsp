                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                 <div class="form-wrap">
                                    ...
                                    <f:form  action="cityUpdate" method="post" modelAttribute="data">
                                     
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                <label class="control-label">City Name:</label>
                                                <f:input type="text" placeholder="Enter City Name" class="form-control" path="cityName"/>
                                             </div>
                                          </div>
                                          <!-- <div class="col-md-6">
                                             <div class="form-group">
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <f:textarea placeholder="Enter City Description" class="form-control" path="cityDescription"/>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">

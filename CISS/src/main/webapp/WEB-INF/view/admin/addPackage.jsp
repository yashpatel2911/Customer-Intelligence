                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                 ...
                                 <%@taglib uri="http://www.springframework.org/tags/form" prefix="f" %>
                                    <f:form  action="insertPackage" method="post" modelAttribute="packageVO">
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <f:input  placeholder="Enter Package Name" class="form-control" path="packageName" />
                                             </div>
                                          </div>
                                        </div>
                                         ...
                                         <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <f:input placeholder="Enter Package Duration" class="form-control" path="packageDuration" />
                                             </div>
                                          </div>
                                         </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-8">
                                             <div class="form-group">
                                                ...
                                                <f:input  placeholder="Enter Package Price" class="form-control" path="packagePrice" />
                                             </div>
                                             </div>
                                          
                                          <div class="col-md-8">
                                             <div class="form-group">
                                                <label class="control-label">No. of Campaign:</label>
                                                <f:input type="number" placeholder="Enter No. of Campaign" class="form-control" path="packageCampaign" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             ...
                                             <div>
                                                ...
                                                <f:textarea placeholder="Enter Package Decription" class="form-control" path="packageDescription" ></f:textarea>
                                             </div>
                                          </div>
                                       <div>
                                       </div>

                        ...
                        <div class="page-box">
                           ...
                           <div class="table-responsive advance-table">
                              <table id="datatables_example_1" class="table display table-bordered">
                                 ...
                                 <c:forEach items="${detasetList}" var="k" varStatus="j">
                                 <tbody>
                                    <tr>
                                      <td>${j.count}</td>
                                       <td><a href="<%=request.getContextPath()%>/document/demo/${k.datasetName}">View</a></td>
                                       <td>${k.datasetName}</td>
                                       <td>${k.datasetDescription}</td>
                                      <td>><a href="datasetDelete.html?datasetId=${k.datasetId}">delete</a></td> 

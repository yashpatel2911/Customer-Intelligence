                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                 ...
                                 <%@taglib uri="http://www.springframework.org/tags/form" prefix="f" %>
                                    <f:form  action="insertCategory" method="post" modelAttribute="data">
                                         ...
                                         <div class="row">
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <textarea placeholder="Enter Category Description" class="form-control" name="categoryDescription" ></textarea>
                                             </div>
                                          </div>
                                       </div>

                        ...
                        <div class="page-box">
                           ...
                           <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                              ...
                              <div class="form-validation-box">
                                 <div class="form-wrap">
                                  <f:form class="needs-validation" action="insertSubCategory"  method="post" modelAttribute="subcategoryVO"> 
										 ...
										 <div class="row">
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <f:input type="text" path="subcategoryName" id="validationCustom01" placeholder="Enter SubCategory Name" class="form-control"/>
                                             </div>
                                             </div>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <f:textarea path="subcategoryDescription" placeholder="Enter SubCategory Description" class="form-control"/>

                           ...
                           <div class="table-responsive advance-table">
                              <table id="datatables_example_1" class="table display table-bordered">
                                 <thead>
                                  ...
                                  <c:forEach items="${campaignList}" var="k">
                                 <tbody>
                                    <tr>
                                       <td>${k.campaignId}</td>
                                       <td>${k.productVO.productName}</td>
                                       <td>${k.campaignName}</td>
                                 		<td>${k.campaignDescription}</td>
                                       
                                       <td><a href="campaignEdit?campaignId=${k.campaignId}">edit</a>/<a href="deleteCampaign?campaignId=${k.campaignId}">delete</a></td>
                                    </tr>

                        ...
                        <div class="page-box">
                           ...
                           <div class="table-responsive advance-table">
                              <table id="datatables_example_1" class="table display table-bordered">
                                 ...
                                 <c:forEach items="${complaintList}" var="k" >
                                 <tbody>
                                    <tr>
                                      <td>${k.id}</td>
                                                    <td>${k.complaintSubject}</td>
                                                    <td>${k.complaintDescription}</td>
                                                    <td> ${k.complaintStatus}</td>
                                                    <td>${k.complaintReply}</td>
                                                    <td>
                                       
                                       <c:if test="${k.complaintStatus eq 'PENDING' }">
                                                    					<a href="replytoUser?id=${k.id}">reply</a>
                                                    	</c:if>
                                                    	<c:if test="${k.complaintStatus ne 'PENDING' }">
                                                    				RESOLVED
                                                    	</c:if>

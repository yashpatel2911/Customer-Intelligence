                              ...
                              <table id="datatables_example_1" class="table display table-bordered">
                                 ...
                                 <tbody>
                                    <tr>
                                      <td>${k.areaId}</td>
                                       <td>${k.areaName}</td>
                                       <td>${k.cityVO.cityName}</td>
                                 		<td>${k.areaDescription}</td>
                                       <td><a href="areaEdit?areaId=${k.areaId}">edit</a>/<a href="deleteArea?areaId=${k.areaId}">delete</a></td>
                                    </tr> 
                                 </tbody>
                                 </c:forEach>
                              </table>

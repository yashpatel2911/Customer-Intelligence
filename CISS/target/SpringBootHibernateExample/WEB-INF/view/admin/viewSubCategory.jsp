<%@ page language="java" contentType="text/html; charset=ISO-8859-1" import="com.project.vo.*"
                           ...
                           <div class="table-responsive advance-table">
                              <table id="datatables_example_1" class="table display table-bordered">
                                 <thead>
                                  ...
                                  <c:forEach items="${subCategoryList}" var="k">
                                 <tbody>
                                    <tr>
                                       <td>${k.subcategoryId}</td>
                                       <td>${k.categoryVO.categoryName}</td>
                                       <td>${k.subcategoryName}</td>
                                 		<td>${k.subcategoryDescription}</td>
                                       
                                       <td><a href="subcategoryEdit?subcategoryId=${k.subcategoryId}">edit</a>/<a href="deleteSubCategory?subcategoryId=${k.subcategoryId}">delete</a></td>
                                    </tr>

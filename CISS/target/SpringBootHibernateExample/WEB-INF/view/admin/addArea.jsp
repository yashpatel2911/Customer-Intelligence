                        ...
                        <div class="page-box">
                           ...
                           <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                              ...
                              <div class="form-validation-box">
                                 <div class="form-wrap">
                                 <f:form class="needs-validation" action="insertArea"  method="post" modelAttribute="areaVO">
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <f:input type="text" path="areaName" placeholder="Enter Area Name" class="form-control"/>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                <label class="control-label">Area Description:</label>
                                                 <f:textarea path="areaDescription" placeholder="Enter Area Description" class="form-control"/>
                                             </div>
                                          </div>
                                       </div>

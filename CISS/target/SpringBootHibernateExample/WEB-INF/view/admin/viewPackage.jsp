                              ...
                              <table id="datatables_example_1" class="table display table-bordered">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>${k.packageId}</td>
                                       <td>${k.packageName}</td>
                                       <td>${k.packageDuration}</td>
                                       <td>${k.packagePrice}</td>
                                       <td>${k.packageCampaign}</td>
                                       <td>${k.packageDescription}</td>
                                       <td><a href="packageEdit?packageId=${k.packageId}">edit</a>/<a href="packageDelete?packageId=${k.packageId}">delete</a></td>

                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                 ...
                                 <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
                                    <f:form  action="categoryUpdate" method="post" modelAttribute="categoryVO">
                                         ...
                                         <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <f:input type="text" placeholder="Enter Category Name" class="form-control" path="categoryName"/>
                                             </div>
                                          </div>
                                         </div>
                                          <f:hidden path="CategoryId"/>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <f:textarea placeholder="Enter Category Description" class="form-control" path="categoryDescription" />
                                             </div>
                                          </div>
                                       </div>

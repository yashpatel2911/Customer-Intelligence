                        ...
                        <div class="page-box">
                           ...
                           <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                              ...
                              <div class="form-validation-box">
                                 <div class="form-wrap">
                                  <f:form class="needs-validation" action="campaignUpdate"  method="post" modelAttribute="campaignVO"> 
                             <f:hidden path="campaignId"/>                  
										 ...
										 <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <div id="slWrapper" class="parsley-select wd-250">
                                                      ...
                                                      <f:select path="productVO.productId" class="form-control">
                                        		<option>Choose Product</option>
                                        		<f:options items="${productList}" itemLabel="productName" itemValue="productId"/>
                                            </f:select>
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <f:input type="text" path="campaignName" id="validationCustom01" placeholder="Enter Campaign Name" class="form-control"/>
                                             </div>
                                             </div>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <f:textarea path="campaignDescription" placeholder="Enter Campaign Description" class="form-control"/>

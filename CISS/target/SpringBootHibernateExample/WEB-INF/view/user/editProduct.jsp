      ...
      <div class="wrapper">
         ...
         <section id="content" class="seipkon-content-wrapper">
          ...
          function subCategoryChange(){
        	 ...
        	 /*  subcategoryId.innerHTML = "<option>select</option>"; */
                        ...
                        <div class="page-box">
                           ...
                           <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                              ...
                              <div class="form-validation-box">
                                 <div class="form-wrap">
                                  <f:form class="needs-validation" action="updateProduct"  method="post" modelAttribute="productVO"> 
										 ...
										 <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <div id="slWrapper" class="parsley-select wd-250">
                                                      ...
                                                      <f:select path="categoryVO.categoryId" id ="categoryId" class="form-control" onchange="subCategoryChange()">
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <div id="slWrapper" class="parsley-select wd-250">
                                                      ...
                                                      <f:select path="subcategoryVO.subcategoryId" id="subcategoryId" class="form-control">
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <f:input type="text" path="productName" id="validationCustom01" placeholder="Enter Product Name" class="form-control"/>
                                             </div>
                                             </div>
                                          </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <f:textarea path="productDescription" placeholder="Enter Product Description" class="form-control"/>
